...
The code is open-source under MIT license, see `License <./license.html>`_ and hosted on the `GitHub rocALUTION page <https://github.com/ROCmSoftwarePlatform/rocALUTION>`_.
