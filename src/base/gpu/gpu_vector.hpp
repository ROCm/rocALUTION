...
private:
  ...
  friend class GPUAcceleratorVector<std::complex<float> >;
  friend class GPUAcceleratorVector<std::complex<double> >;
  ...
  friend class GPUAcceleratorMatrixCOO<std::complex<double> >;
  friend class GPUAcceleratorMatrixCOO<std::complex<float> >;

  friend class GPUAcceleratorMatrixCSR<double>;
  friend class GPUAcceleratorMatrixCSR<float>;
  friend class GPUAcceleratorMatrixCSR<std::complex<double> >;
  friend class GPUAcceleratorMatrixCSR<std::complex<float> >;
