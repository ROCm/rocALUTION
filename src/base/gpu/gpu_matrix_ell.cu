...
template <>
bool GPUAcceleratorMatrixELL<std::complex<double> >::ConvertFrom(const BaseMatrix<std::complex<double> > &mat) {
  ...
  const GPUAcceleratorMatrixELL<std::complex<double> > *cast_mat_ell;

  if ((cast_mat_ell = dynamic_cast<const GPUAcceleratorMatrixELL<std::complex<double> >*> (&mat)) != NULL) {
  ...
  const GPUAcceleratorMatrixCSR<std::complex<double> > *cast_mat_csr;
  if ((cast_mat_csr = dynamic_cast<const GPUAcceleratorMatrixCSR<std::complex<double> >*> (&mat)) != NULL) {
...
template <>
bool GPUAcceleratorMatrixELL<std::complex<float> >::ConvertFrom(const BaseMatrix<std::complex<float> > &mat) {
  ...
  const GPUAcceleratorMatrixELL<std::complex<float> > *cast_mat_ell;

  if ((cast_mat_ell = dynamic_cast<const GPUAcceleratorMatrixELL<std::complex<float> >*> (&mat)) != NULL) {
  ...
  const GPUAcceleratorMatrixCSR<std::complex<float> > *cast_mat_csr;
  if ((cast_mat_csr = dynamic_cast<const GPUAcceleratorMatrixCSR<std::complex<float> >*> (&mat)) != NULL) {
...
template class GPUAcceleratorMatrixELL<std::complex<double> >;
template class GPUAcceleratorMatrixELL<std::complex<float> >;
#endif
