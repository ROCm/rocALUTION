#ifndef PARALUTION_OCL_MATH_INT_HPP_
#define PARALUTION_OCL_MATH_INT_HPP_

namespace paralution {

const char *ocl_kernels_math_int = CL_KERNEL(

// Assigns scalar
inline static ValueType ocl_set(const ValueType val) { return val; }

// Absolute value
inline static ValueType ocl_abs(const ValueType val) { return abs(val); }
...
// Replaces power
inline static ValueType ocl_pow(const ValueType x, const ValueType y) {
...
#endif // PARALUTION_OCL_MATH_INT_HPP_
