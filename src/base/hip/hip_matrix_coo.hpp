#ifndef PARALUTION_HIP_MATRIX_COO_HPP_
#define PARALUTION_HIP_MATRIX_COO_HPP_
...
public:
  ...
  HIPAcceleratorMatrixCOO(const Paralution_Backend_Descriptor local_backend);
...
#endif // PARALUTION_HIP_MATRIX_COO_HPP_
