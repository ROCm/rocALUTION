...
void ParallelManager::SetGlobalSize(const IndexType2 size) {
...
void ParallelManager::SetLocalSize(const int size) {
...
void ParallelManager::SetBoundaryIndex(const int size, const int *index) {
...
void ParallelManager::SetReceivers(const int nrecv, const int *recvs, const int *recv_offset) {
...
void ParallelManager::SetSenders(const int nsend, const int *sends, const int *send_offset) {
