...
void BaseMultiGrid<OperatorType, VectorType, ValueType>::MoveHostLevels(void) {
  ...
  log_debug(this, "BaseMultiGrid::MoveHostLevels()",
            this->build_);
  ...
  if (this->current_level_ < this->levels_-1) {
    ...
    if (this->current_level_ == this->levels_ - this->host_level_ - 1) {
      if (this->current_level_ == 0) {
        ...
        this->s_level_[this->current_level_]->CloneBackend(*this->op_level_[this->current_level_-1]);
      }
    }
    ...
    if (this->current_level_ == this->levels_ - this->host_level_) {
      if (this->current_level_ == 1) {
        ...
        this->r_level_[this->current_level_-1]->CloneBackend(*this->op_level_[this->current_level_-2]);
      }
    }
...
#ifdef SUPPORT_COMPLEX
template class BaseMultiGrid< GlobalMatrix<std::complex<double> >, GlobalVector<std::complex<double> >, std::complex<double> >;
template class BaseMultiGrid< GlobalMatrix<std::complex<float> >,  GlobalVector<std::complex<float> >,  std::complex<float> >;
#endif
