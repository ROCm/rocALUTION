...
void IDR<OperatorType, VectorType, ValueType>::ReBuildNumeric(void) {
  ...
  LOG_DEBUG(this, "IDR::ReBuildNumeric()",
            this->build_);
...
#ifdef SUPPORT_COMPLEX
template class IDR< GlobalMatrix<std::complex<double> >, GlobalVector<std::complex<double> >, std::complex<double> >;
template class IDR< GlobalMatrix<std::complex<float> >,  GlobalVector<std::complex<float> >,  std::complex<float> >;
#endif
