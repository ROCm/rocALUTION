...
void CG<OperatorType, VectorType, ValueType>::BuildMoveToAcceleratorAsync(void) {
  ...
  LOG_DEBUG(this, "CG::BuildMoveToAcceleratorAsync()",
            this->build_ <<
            " #*# begin");
...
void CG<OperatorType, VectorType, ValueType>::ReBuildNumeric(void) {
  ...
  LOG_DEBUG(this, "CG::ReBuildNumeric()",
            this->build_);
...
#ifdef SUPPORT_COMPLEX
template class CG< GlobalMatrix<std::complex<double> >,  GlobalVector<std::complex<double> >, std::complex<double> >;
template class CG< GlobalMatrix<std::complex<float> >,  GlobalVector<std::complex<float> >, std::complex<float> >;
#endif
