...
void testing_local_matrix_bad_args(void)
{
    ...
    // SetDataPtr
    {
        ...
        ASSERT_DEATH(mat1.SetDataPtrCOO(&vint, &null_int, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*col != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCOO(&vint, &vint, &null_data, "", safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCOO(nullptr, &vint, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*row != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCOO(&vint, nullptr, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*col != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCOO(&vint, &vint, nullptr, "", safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCSR(&null_int, &vint, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*row_offset != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCSR(&vint, &null_int, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*col != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCSR(&vint, &vint, &null_data, "", safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCSR(nullptr, &vint, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*row_offset != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCSR(&vint, nullptr, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*col != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrCSR(&vint, &vint, nullptr, "", safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrMCSR(&null_int, &vint, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*row_offset != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrMCSR(&vint, &null_int, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*col != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrMCSR(&vint, &vint, &null_data, "", safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrMCSR(nullptr, &vint, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*row_offset != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrMCSR(&vint, nullptr, &vdata, "", safe_size, safe_size, safe_size), ".*Assertion.*col != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrMCSR(&vint, &vint, nullptr, "", safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrELL(&null_int, &vdata, "", safe_size, safe_size, safe_size, safe_size), ".*Assertion.*col != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrELL(&vint, &null_data, "", safe_size, safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrELL(nullptr, &vdata, "", safe_size, safe_size, safe_size, safe_size), ".*Assertion.*col != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrELL(&vint, nullptr, "", safe_size, safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrDIA(&null_int, &vdata, "", safe_size, safe_size, safe_size, safe_size), ".*Assertion.*offset != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrDIA(&vint, &null_data, "", safe_size, safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrDIA(nullptr, &vdata, "", safe_size, safe_size, safe_size, safe_size), ".*Assertion.*offset != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrDIA(&vint, nullptr, "", safe_size, safe_size, safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrDENSE(&null_data, "", safe_size, safe_size), ".*Assertion.*val != NULL*");
        ASSERT_DEATH(mat1.SetDataPtrDENSE(nullptr, "", safe_size, safe_size), ".*Assertion.*val != NULL*");
    }

    // LeaveDataPtr
    {
        int val;
        ASSERT_DEATH(mat1.LeaveDataPtrCOO(&vint, &null_int, &null_data), ".*Assertion.*row == NULL*");
        ASSERT_DEATH(mat1.LeaveDataPtrCOO(&null_int, &vint, &null_data), ".*Assertion.*col == NULL*");
        ASSERT_DEATH(mat1.LeaveDataPtrCOO(&null_int, &null_int, &vdata), ".*Assertion.*val == NULL*");
        ASSERT_DEATH(mat1.LeaveDataPtrCSR(&vint, &null_int, &null_data), ".*Assertion.*row_offset == NULL*");
        ASSERT_DEATH(mat1.LeaveDataPtrCSR(&null_int, &vint, &null_data), ".*Assertion.*col == NULL*");
        ASSERT_DEATH(mat1.LeaveDataPtrCSR(&null_int, &null_int, &vdata), ".*Assertion.*val == NULL*");
        ASSERT_DEATH(mat1.LeaveDataPtrMCSR(&vint, &null_int, &null_data), ".*Assertion.*row_offset == NULL*");
        ASSERT_DEATH(mat1.LeaveDataPtrMCSR(&null_int, &vint, &null_data), ".*Assertion.*col == NULL*");
        ASSERT_DEATH(mat1.LeaveDataPtrMCSR(&null_int, &null_int, &vdata), ".*Assertion.*val == NULL*");
    ...
    // AMG
    {
        ...
        ASSERT_DEATH(mat1.FurtherPairwiseAggregation(0.1, val, null_vec, val, &null_int, val, 0), ".*Assertion.*G != NULL*");
        ASSERT_DEATH(mat1.FurtherPairwiseAggregation(0.1, val, &int1, val, &vint, val, 0), ".*Assertion.*rG == NULL*");
        ASSERT_DEATH(mat1.FurtherPairwiseAggregation(*null_mat, 0.1, val, &int1, val, &null_int, val, 0), ".*Assertion.*mat != NULL*");
        ASSERT_DEATH(mat1.FurtherPairwiseAggregation(mat2, 0.1, val, null_vec, val, &null_int, val, 0), ".*Assertion.*G != NULL*");
        ASSERT_DEATH(mat1.FurtherPairwiseAggregation(mat2, 0.1, val, &int1, val, &vint, val, 0), ".*Assertion.*rG == NULL*");
