...
int main(int argc, char* argv[]) {
  ...
  // Linear Solver
  BiCGStab<LocalMatrix<ValueType>, LocalVector<ValueType>, ValueType > ls;
  ...
  if ( pName == "MultiColoredGS" ) p = new MultiColoredGS<LocalMatrix<ValueType>, LocalVector<ValueType>, ValueType >; ls.SetPreconditioner(*p);
