...
int main(int argc, char* argv[]) {
  ...
  if (pName == "SGS")    p = new SGS<LocalMatrix<ValueType>, LocalVector<ValueType>, ValueType>;
  ...
  if (pName == "MCSGS")  p = new MultiColoredSGS<LocalMatrix<ValueType>, LocalVector<ValueType>, ValueType>;
