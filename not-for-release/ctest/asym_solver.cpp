...
int main(int argc, char* argv[]) {
  ...
  if (pName == "GS")     p = new GS<LocalMatrix<ValueType>, LocalVector<ValueType>, ValueType>;
  ...
  if (pName == "MCGS")   p = new MultiColoredGS<LocalMatrix<ValueType>, LocalVector<ValueType>, ValueType>;
